...
public class InstructionsPanel extends JPanel {
    public InstructionsPanel(ActionListener backClick) {
        ...
        JLabel text = new JLabel("<html>" +
                ...
                "<br />F2: forward 2" +
                "<br />There may be boulders in the way. Every move has an attached stamina value (0 by default). 50 stamina is needed to push 1 boulder. If 2 boulders are adjacent, the robot can push both with 100 stamina. You are in charge of calculating when stamina is needed and how much should be used." +
